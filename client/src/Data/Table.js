...
export function getHeaderRow(page) {
    ...
    if (page === Page.Account) {
        headerRowText.push("STT");
        headerRowText.push("Username");
        headerRowText.push("Họ và tên");
        headerRowText.push("Năm sinh");
        headerRowText.push("Thời gian tạo");
        headerRowText.push("Vai trò");
    } else if (page === Page.HireRecruiter) {
        headerRowText.push("STT");
        headerRowText.push("Username đăng bài");
        headerRowText.push("Họ và tên");
        headerRowText.push("Công ty");
        headerRowText.push("Thời gian tạo");
        headerRowText.push("Tiêu đề");
    }
