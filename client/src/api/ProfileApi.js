...
class ProfileApi {
    ...
    static UpdateUserProperty(user, title, newValue) {
        ...
        return axios.put(this.userApiUrl + user.id + "/property/edit", config).then((response) => {
    ...
    static DeleteUserProperty(user, title) {
        ...
        return axios.delete(this.userApiUrl + user.id + "/property/delete", { data: config }).then((response) => {
            return response.data;
        });
    }
    ...
    static GetUserFollowing(user) {
        return axios.get(this.followingApiUrl + "?userId=" + user.id).then((response) => {
            return response.data.Followee;
        });
    }

    static GetBookmarkedJobs(user) {
        return axios.get(this.bookmarkApiUrl + "/list?userId=" + user.id).then((response) => {
