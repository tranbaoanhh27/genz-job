...
const SAMPLE_NOTIFICATIONS = [
    {
        id: "noti#1",
        imageUrl:
            "https://i.pinimg.com/originals/37/bf/67/37bf67a897c5dcd22a5971b68ad189f4.jpg",
    ...
    },
    {
        id: "noti#5",
        imageUrl:
            "https://i.pinimg.com/originals/ec/fd/fd/ecfdfdc0cb586b2784096f8699feb630.jpg",
        content: "Tran Bao Anh liked your profile picture!",
        notifyTime: new Date("2019-10-12"),
        readState: "read",
    },
...
export default function RecruiterNotifications(props) {
        ...
        setNotifications((prevNotifications) =>
            prevNotifications.map((notification) => {
                if (notification.id === id)
                    return { ...notification, readState: state };
